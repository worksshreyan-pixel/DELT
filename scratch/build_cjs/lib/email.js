...
exports.sendProposalStatusEmail = exports.sendDealCompletionEmail = exports.sendDeliverablesUploadedEmail = exports.sendPaymentConfirmationEmail = exports.sendDealInvitationEmail = exports.sendDealOtpEmail = exports.sendOtpEmail = void 0;
...
async function sendRawEmail(params) {
    ...
    const fromAddress = env_1.env.email.from;
    ...
    try {
        const res = await fetch('https://api.resend.com/emails', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${env_1.env.email.resendApiKey}`,
...
async function sendOtpEmail(payload) {
    const { to, otpCode, expiresInMinutes = 10, subject = 'Your DELT verification code', } = payload;
    const html = `
<!DOCTYPE html>
<html>
<head>
 ...
 */
async function sendDealOtpEmail(payload) {
    return sendOtpEmail({
...
exports.sendDealOtpEmail = sendDealOtpEmail;
// ------------------------------------------------------------------------------
// 2. Client Deal Invitation Email
// ------------------------------------------------------------------------------
async function sendDealInvitationEmail(payload) {
    const { clientName, clientEmail, creatorName, dealTitle, dealDescription, dealPrice, dealCurrency, dealUrl, } = payload;
...
exports.sendDealInvitationEmail = sendDealInvitationEmail;
// ------------------------------------------------------------------------------
// 3. Payment Confirmation Email
// ------------------------------------------------------------------------------
async function sendPaymentConfirmationEmail(payload) {
    const { recipientName, recipientEmail, creatorName, dealTitle, amount, currency, transactionId, isCreator, dealUrl, } = payload;
...
// ------------------------------------------------------------------------------
async function sendDeliverablesUploadedEmail(payload) {
    const { clientName, clientEmail, creatorName, dealTitle, versionNumber, fileNames = [], dealUrl, } = payload;
    const html = `
<!DOCTYPE html>
<html>
<head>
...
exports.sendDeliverablesUploadedEmail = sendDeliverablesUploadedEmail;
// ------------------------------------------------------------------------------
// 5. Deal Completion Email
// ------------------------------------------------------------------------------
async function sendDealCompletionEmail(payload) {
...
exports.sendDealCompletionEmail = sendDealCompletionEmail;
// ------------------------------------------------------------------------------
// 6. Proposal Status Email (Accepted / Declined)
// ------------------------------------------------------------------------------
async function sendProposalStatusEmail(payload) {
    const { recipientName, recipientEmail, responderName, dealTitle, price, currency, accepted, dealUrl, } = payload;
...
exports.sendProposalStatusEmail = sendProposalStatusEmail;
