...
export function ChatMessageItem(_a) {
    var message = _a.message, isCurrentUser = _a.isCurrentUser, showAvatar = _a.showAvatar, children = _a.children;
    ...
    return (<motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2, ease: [0.16, 1, 0.3, 1] }} className={cn('flex gap-3', isCurrentUser ? 'flex-row-reverse' : 'flex-row')}>
      ...
      <div className={cn('flex flex-col gap-1 max-w-[75%]', isCurrentUser ? 'items-end' : 'items-start')}>
        ...
        {children ? (children) : (<div className={cn('rounded-2xl px-3.5 py-2 text-sm', isCurrentUser
