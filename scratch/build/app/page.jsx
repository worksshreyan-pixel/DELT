...
import { ArrowRight, MessageSquare, ArrowLeftRight, FileCheck, CreditCard, CheckCircle2, Lock, Shield, Users, FolderKanban, Activity, } from 'lucide-react';
    ...
    return (<div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 pt-20 pb-16 sm:pt-28 sm:pb-24">
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1] }} className="mx-auto max-w-3xl text-center">
          ...
          {/* Dashboard Preview */}
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2, ease: [0.16, 1, 0.3, 1] }} className="mx-auto mt-16 max-w-5xl">
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mx-auto max-w-3xl">
            <div className="flex flex-wrap items-center justify-center gap-3 text-sm font-medium">
              {['WhatsApp', 'Email', 'Google Drive', 'Payment Links', 'Spreadsheets', 'Manual Invoices'].map(function (tool, i) { return (<div key={tool} className="flex items-center gap-3">
      ...
      <section className="border-t border-border bg-muted/20 py-20 sm:py-28">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {steps.map(function (step, i) { return (<motion.div key={step.title} initial={{ opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.3, delay: i * 0.05 }}>
      ...
      <section className="border-t border-border bg-muted/20 py-20 sm:py-28">
        ...
        ].map(function (item) { return (<li key={item} className="flex items-center gap-2 text-sm">
      ...
      <section className="border-t border-border py-20 sm:py-28">
        ...
        ].map(function (feature) { return (<Card key={feature.title} className="h-full">
                <CardContent className="p-6">
      ...
      <section className="border-t border-border bg-muted/20 py-20 sm:py-28">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {useCases.map(function (uc) { return (<div key={uc.label} className="flex items-center gap-2 rounded-xl border border-border bg-card px-5 py-3 text-sm font-medium shadow-sm transition-colors hover:bg-accent/50">
      ...
      <section className="border-t border-border py-20 sm:py-28">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {plans.map(function (plan) { return (<Card key={plan.name} className={plan.highlighted
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[200px_1fr]">
        ...
        <div className="hidden border-r border-border bg-muted/20 p-3 lg:block">
          <div className="space-y-1">
            {['Dashboard', 'Deals', 'Clients', 'Templates', 'Transactions', 'Storage', 'Settings'].map(function (item, i) { return (<div key={item} className={"flex items-center gap-2 rounded-md px-2.5 py-1.5 text-xs font-medium ".concat(item === 'Deals' ? 'bg-primary text-primary-foreground' : 'text-muted-foreground')}>
...
function WorkspaceFeatureGrid() {
    ...
    return (<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {features.map(function (f) { return (<Card key={f.title} className="h-full">
          <CardContent className="p-6">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary/5 mb-3">
