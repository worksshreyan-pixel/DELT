            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!hasSupabasePublicConfig()) {
                        return [2 /*return*/, createServerClient(env.supabase.url || 'https://placeholder.supabase.co', env.supabase.anonKey || 'placeholder-key', {
                                cookies: {
                                    get: function (name) {
                                        var _a;
                    ...
                    return [2 /*return*/, createServerClient(env.supabase.url, env.supabase.anonKey, {
                            cookies: {
                                get: function (name) {
                                    var _a;
                                    return (_a = cookieStore.get(name)) === null || _a === void 0 ? void 0 : _a.value;
