...
import type { DealStatus, PaymentState, ProposalState, DeliverableStatus, MilestoneStatus } from '@/lib/types';
...
const proposalConfig: Record<ProposalState, { label: string; className: string }> = {
  pending: { label: 'Pending', className: 'bg-amber-50 text-amber-700 dark:bg-amber-950 dark:text-amber-300' },
...
const deliverableConfig: Record<DeliverableStatus, { label: string; className: string }> = {
...
const milestoneConfig: Record<MilestoneStatus, { label: string; className: string }> = {
  pending: { label: 'Pending', className: 'bg-muted text-muted-foreground' },
  in_progress: { label: 'In Progress', className: 'bg-indigo-50 text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300' },
